...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/admin/coaches', element: <ProtectedRoute requiredRole="superadmin"><Coaches /></ProtectedRoute> },
      { path: '/admin/assign-players', element: <ProtectedRoute requiredRole="superadmin"><AssignPlayers /></ProtectedRoute> },
