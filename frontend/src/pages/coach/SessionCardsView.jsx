  ...
  return (
    ...
    onMouseLeave={(e) => {
      ...
      <div style={{ padding: '20px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <p style={{ fontSize: '13px', color: '#6B7280', margin: '0 0 16px 0', lineHeight: '1.6', minHeight: '32px' }}>
        ...
        {session.activities && session.activities.length > 0 && (
          <div style={{ background: '#F9FAFB', padding: '10px 12px', borderRadius: '8px', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '8px' }}>
      ...
      {/* Action Button */}
      <div style={{ padding: '16px 20px', borderTop: '1px solid #F3F4F6', background: '#FAFBFC' }}>
        <button
          onClick={() => {
